...
var d=c.next;c.Cj=function(){return g.cp(d.call(c))};
...
try{d=a.Cj()}catch(e){if(e===g.bp)break;throw e;}try{b.call(c,d,void 0,a)}catch(e){VUa(e)}}},YUa=function(a,b){var c=[];
...
if(1<a){var c=a-1;b.push("//www.gstatic.com/eureka/clank/"+a+"/cast_sender.js");b.push("//www.gstatic.com/eureka/clank/"+c+"/cast_sender.js")}return b},j7=function(){var a=vVa();
a&&a(!1,"No cast extension found")},k7=function(){if(zVa){var a=2,b=vVa(),c=function(){a--;
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;wVa("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",j7,c)}},AVa=function(){k7();
var a=yVa();a.push("//www.gstatic.com/eureka/clank/cast_sender.js");i7(a)},CVa=function(){k7();
var a=yVa();a.push.apply(a,g.ma(BVa.map(xVa)));a.push("//www.gstatic.com/eureka/clank/cast_sender.js");i7(a)},l7=function(a,b,c){g.E.call(this);
this.I=null!=c?(0,g.C)(a,c):a;this.Wf=b;this.D=(0,g.C)(this.FQ,this);this.i=!1;this.u=0;this.B=this.Mb=null;this.C=[]},m7=function(a,b,c){g.E.call(this);
...
this.B=b;this.S=c;this.K=d||1;this.u=45E3;this.C=new g.ol(this);this.I=new g.Xh;this.I.setInterval(250)},FVa=function(a,b,c){a.Pt=1;
a.cn=P6(b.clone());a.Aq=c;a.D=!0;EVa(a,null)},t7=function(a,b,c,d,e){a.Pt=1;
a.cn=P6(b.clone());a.Aq=null;a.D=c;e&&(a.SN=!1);EVa(a,d)},EVa=function(a,b){a.Ct=Date.now();
u7(a);a.Ko=a.cn.clone();Q6(a.Ko,"t",a.K);a.BB=0;a.Lf=a.i.xD(a.i.qx()?b:null);0<a.nC&&(a.PA=new m7((0,g.C)(a.WO,a,a.Lf),a.nC));a.C.Ra(a.Lf,"readystatechange",a.GQ);b=a.Zo?g.We(a.Zo):{};a.Aq?(a.zB="POST",b["Content-Type"]="application/x-www-form-urlencoded",a.Lf.send(a.Ko,a.zB,a.Aq,b)):(a.zB="GET",a.SN&&!g.Xg&&(b.Connection="close"),a.Lf.send(a.Ko,a.zB,null,b));a.i.Dj(1)},HVa=function(a,b){var c=a.BB,d=b.indexOf("\n",c);
if(-1==d)return v7;c=Number(b.substring(c,d));if(isNaN(c))return GVa;d+=1;if(d+c>b.length)return v7;b=b.substr(d,c);a.BB=d+c;return b},JVa=function(a,b){a.Ct=Date.now();
...
y7[f]=l}f=e+f}e=f}d+='<script>document.domain="'+e+'"\x3c/script>'}d+="</body></html>";c=g.lg(g.Hf("b/12014412"),d);a.Rj.open();a.Rj.write(g.hg(c));a.Rj.close();a.Rj.parentWindow.m=(0,g.C)(a.yW,a);a.Rj.parentWindow.d=(0,g.C)(a.dN,a,!0);a.Rj.parentWindow.rpcClose=(0,g.C)(a.dN,a,!1);c=a.Rj.createElement("DIV");a.Rj.parentWindow.document.body.appendChild(c);d=g.Wf(a.Ko.toString());d=g.Cg(g.Qf(d));d=g.lg(g.Hf("b/12014412"),'<iframe src="'+d+'"></iframe>');g.ng(c,d);a.i.Dj(1)},u7=function(a){a.oH=Date.now()+
a.u;
KVa(a,a.u)},KVa=function(a,b){if(null!=a.au)throw Error("WatchDog timer not null");
a.au=p7((0,g.C)(a.HW,a),b)},z7=function(a){a.au&&(g.B.clearTimeout(a.au),a.au=null)},x7=function(a){a.i.sf()||a.vp||a.i.ey(a)},w7=function(a){z7(a);
g.re(a.PA);a.PA=null;a.I.stop();g.ql(a.C);if(a.Lf){var b=a.Lf;a.Lf=null;b.abort();b.dispose()}a.Rj&&(a.Rj=null)},A7=function(a,b){try{a.i.WM(a,b),a.i.Dj(4)}catch(c){}},MVa=function(a,b,c,d,e){if(0==d)c(!1);
...
P6(b);MVa(b.toString(),5E3,(0,g.C)(a.uR,a),3,2E3);a.Dj(1)},E7=function(a){var b=a.i.X;
if(null!=b)r7(5),b?(r7(11),D7(a.i,a,!1)):(r7(12),D7(a.i,a,!0));else if(a.uh=new s7(a,void 0,void 0,void 0),a.uh.Zo=a.oC,b=a.i,b=C7(b,b.qx()?a.Iu:null,a.pC),r7(5),!g.Jc||g.Bc(10))Q6(b,"TYPE","xmlhttp"),t7(a.uh,b,!1,a.Iu,!1);else{Q6(b,"TYPE","html");var c=a.uh;a=!!a.Iu;c.Pt=3;c.cn=P6(b.clone());JVa(c,a)}},F7=function(a,b,c){this.i=1;
...
if(3==a.i){var b=a.qw++,c=a.Vy.clone();g.il(c,"SID",a.B);g.il(c,"RID",b);g.il(c,"TYPE","terminate");G7(a,c);b=new s7(a,a.B,b,void 0);b.Pt=2;b.cn=P6(c.clone());UUa(new Image,b.cn.toString());b.Ct=Date.now();u7(b)}TVa(a)},VVa=function(a){a.UR(1,0);
...
a.Je&&b++;a.Ug&&b++;return b},H7=function(a){a.Ug||a.Cn||(a.Cn=p7((0,g.C)(a.bN,a),0),a.ws=0)},ZVa=function(a,b){if(1==a.i){if(!b){a.qw=Math.floor(1E5*Math.random());
b=a.qw++;var c=new s7(a,"",b,void 0);c.Zo=a.dk;var d=J7(a),e=a.Vy.clone();g.il(e,"RID",b);g.il(e,"CVER","1");G7(a,e);FVa(c,e,d);a.Ug=c;a.i=2}}else 3==a.i&&(b?YVa(a,b):0==a.u.length||a.Ug||YVa(a))},YVa=function(a,b){if(b)if(6<a.wp){a.u=a.C.concat(a.u);
a.C.length=0;var c=a.qw-1;b=J7(a)}else c=b.S,b=b.Aq;else c=a.qw++,b=J7(a);var d=a.Vy.clone();g.il(d,"SID",a.B);g.il(d,"RID",c);g.il(d,"AID",a.Ss);G7(a,d);c=new s7(a,a.B,c,a.ws+1);c.Zo=a.dk;c.setTimeout(1E4+Math.round(1E4*Math.random()));a.Ug=c;FVa(c,d,b)},G7=function(a,b){a.Mf&&(a=a.Mf.vK())&&g.De(a,function(c,d){g.il(b,d,c)})},J7=function(a){var b=Math.min(a.u.length,1E3),c=["count="+b];
...
return c.join("&")},$Va=function(a){a.Je||a.Il||(a.K=1,a.Il=p7((0,g.C)(a.aN,a),0),a.Rr=0)},K7=function(a){if(a.Je||a.Il||3<=a.Rr)return!1;
a.K++;a.Il=p7((0,g.C)(a.aN,a),aWa(a,a.Rr));a.Rr++;return!0},D7=function(a,b,c){a.xB=c;
a.ek=b.vl;a.I||VVa(a)},I7=function(a){null!=a.Ep&&(g.B.clearTimeout(a.Ep),a.Ep=null)},aWa=function(a,b){var c=5E3+Math.floor(1E4*Math.random());
a.isActive()||(c*=2);return c*b},L7=function(a,b){if(2==b||9==b){var c=null;
a.Mf&&(c=null);var d=(0,g.C)(a.IX,a);c||(c=new g.Qk("//www.google.com/images/cleardot.gif"),P6(c));LVa(c.toString(),1E4,d)}else r7(2);bWa(a,b)},bWa=function(a,b){a.i=0;
a.Mf&&a.Mf.IJ(b);TVa(a);SVa(a)},TVa=function(a){a.i=0;
a.ek=-1;if(a.Mf)if(0==a.C.length&&0==a.u.length)a.Mf.kD();else{g.fc(a.C);var b=g.fc(a.u);a.C.length=0;a.u.length=0;a.Mf.kD(b)}},C7=function(a,b,c){var d=g.jl(c);
...
g.il(d,"VER",a.wp);G7(a,d);return d},cWa=function(){},dWa=function(){this.i=[];
this.u=[]},eWa=function(a,b){this.action=a;
this.params=b||{}},M7=function(a,b){g.E.call(this);
this.i=new g.I(this.pW,0,this);g.H(this,this.i);this.Wf=5E3;this.u=0;if("function"===typeof a)b&&(a=(0,g.C)(a,b));else if(a&&"function"===typeof a.handleEvent)a=(0,g.C)(a.handleEvent,a);else throw Error("Invalid listener argument");this.B=a},N7=function(a,b,c,d,e){c=void 0===c?!1:c;
d=void 0===d?function(){return""}:d;
e=void 0===e?!1:e;this.xa=a;this.I=b;this.B=new g.ks;this.u=new M7(this.mX,this);this.i=null;this.Z=!1;this.D=null;this.X="";this.S=this.C=0;this.K=[];this.Aa=c;this.oa=d;this.Ba=e},fWa=function(a){return{firstTestResults:[""],
secondTestResults:!a.i.xB,sessionId:a.i.B,arrayId:a.i.Ss}},gWa=function(a,b){a.S=b||0;
a.u.stop();O7(a);a.i&&(3==a.i.getState()&&ZVa(a.i),UVa(a.i));a.S=0},P7=function(a){return!!a.i&&3==a.i.getState()},O7=function(a){if(a.i){var b=a.oa(),c=a.i.dk||{};
...
var d=this;this.config_=c;this.u=null;this.oa=(0,g.C)(this.LQ,this);this.Aa=(0,g.C)(this.LW,this);this.Z=g.Qt(function(){CWa(d,null)},12E4);
...
this.u=g.Qt((0,g.C)(this.Ts,this,null),150)},v8=function(a,b){g.Q.call(this);
...
b.i):a.ea("yt-remote-cast2-receiver-selected",b.i),b.subscribe("sessionScreen",(0,g.C)(a.ZM,a,b)),b.subscribe("sessionFailed",function(){return RWa(a,b)}),b.getScreen()?a.ea("yt-remote-cast2-session-change",b.getScreen()):c&&a.i.Ts(null)):a.ea("yt-remote-cast2-session-change",null))},RWa=function(a,b){a.i==b&&a.ea("yt-remote-cast2-session-failed")},SWa=function(a){var b=a.u.qI(),c=a.i&&a.i.i;
...
this.videoId=this.listId="";this.volume=this.playerState=-1;this.muted=!1;this.audioTrackId=null;this.I=this.K=0;this.trackData=null;this.hasNext=this.Kk=!1;this.S=this.D=this.i=this.C=0;this.B=NaN;this.u=!1;this.reset(a)},K8=function(a){a.audioTrackId=null;
a.trackData=null;a.playerState=-1;a.Kk=!1;a.hasNext=!1;a.K=0;a.I=g.Ta();a.C=0;a.i=0;a.D=0;a.S=0;a.B=NaN;a.u=!1},L8=function(a){return a.Ec()?(g.Ta()-a.I)/1E3:0},M8=function(a,b){a.K=b;
...
b.index=a.index;b.listId=a.listId;b.videoId=a.videoId;b.playerState=a.playerState;b.volume=a.volume;b.muted=a.muted;b.audioTrackId=a.audioTrackId;b.trackData=g.Xe(a.trackData);b.hasPrevious=a.Kk;b.hasNext=a.hasNext;b.playerTime=a.K;b.playerTimeAt=a.I;b.seekableStart=a.C;b.seekableEnd=a.i;b.duration=a.D;b.loadedTime=a.S;b.liveIngestionTime=a.B;return b},R8=function(a,b){g.Q.call(this);
...
g.Q.call(this);this.D=NaN;this.xa=!1;this.S=this.K=this.Z=this.oa=NaN;this.X=[];this.C=this.I=this.B=this.lc=this.i=null;this.Ja=a;this.Ba=d;this.X.push(g.Zu(window,"beforeunload",(0,g.C)(this.nS,this)));this.u=[];this.lc=new J8;this.Ka=b.id;this.Aa=b.idType;this.i=fXa(this,c);this.i.subscribe("handlerOpened",this.oU,this);this.i.subscribe("handlerClosed",this.lU,this);this.i.subscribe("handlerError",this.mU,this);this.i.subscribe("handlerMessage",this.nU,this);this.i.bB(b.token);this.subscribe("remoteQueueChange",
function(){var e=this.lc.videoId;g.yy()&&g.uy("yt-remote-session-video-id",e)},this)},gXa=function(a){return g.Tb(a.u,function(b){return"LOUNGE_SCREEN"==b.type})},$8=function(a){U7("conn",a)},fXa=function(a,b){return new N7(R7(a.Ja,"/bc"),b,!1,function(){return a.vI()},"shortLived"==a.Aa)},a9=function(a,b){a.ea("proxyStateChange",b)},hXa=function(a){a.D=g.Qt((0,g.C)(function(){$8("Connecting timeout");
this.ls(1)},a),2E4)},b9=function(a){g.hu(a.D);
...
if(b){var d=gXa(a);d&&(c={clientName:d.clientName,deviceMake:d.brand,deviceModel:d.model,osVersion:d.osVersion})}g.Ia("yt.mdx.remote.remoteClient_",c,void 0);b&&(b9(a),c9(a));c=P7(a.i)&&isNaN(a.D);b==c?b&&(a9(a,1),e9(a,"getSubtitlesTrack")):b?(a.HK()&&a.lc.reset(),a9(a,1),e9(a,"getNowPlaying"),jXa(a)):a.ls(1)},lXa=function(a,b){var c=b.params.videoId;
delete b.params.videoId;c==a.lc.videoId&&(g.Se(b.params)?a.lc.trackData=null:a.lc.trackData=b.params,a.ea("remotePlayerChange"))},mXa=function(a,b,c){var d=b.params.videoId||b.params.video_id,e=parseInt(b.params.currentIndex,10);
a.lc.listId=b.params.listId||a.lc.listId;O8(a.lc,d,e);a.ea("remoteQueueChange",c)},oXa=function(a,b){b.params=b.params||{};
...
M8(a.lc,isNaN(c)?0:c);c=parseInt(b.params.state,10);c=isNaN(c)?-1:c;-1==c&&-1E3==a.lc.playerState&&(c=-1E3);a.lc.playerState=c;c=Number(b.params.loadedTime);a.lc.S=isNaN(c)?0:c;a.lc.Nj(Number(b.params.duration));c=a.lc;var d=Number(b.params.liveIngestionTime);c.B=d;c.u=isNaN(d)?!1:!0;c=a.lc;d=Number(b.params.seekableStartTime);b=Number(b.params.seekableEndTime);c.C=isNaN(d)?0:d;c.i=isNaN(b)?0:b;1==a.lc.playerState?iXa(a):d9(a);a.ea("remotePlayerChange")},pXa=function(a,b){if(-1E3!=a.lc.playerState){var c=
1085;
switch(parseInt(b.params.adState,10)){case 1:c=1081;break;case 2:c=1084;break;case 0:c=1083}a.lc.playerState=c;b=parseInt(b.params.currentTime,10);M8(a.lc,isNaN(b)?0:b);a.ea("remotePlayerChange")}},qXa=function(a,b){var c="true"==b.params.muted;
a.lc.volume=parseInt(b.params.volume,10);a.lc.muted=c;a.ea("remotePlayerChange")},rXa=function(a,b){a.I=b.params.videoId;
a.ea("nowAutoplaying",parseInt(b.params.timeout,10))},sXa=function(a,b){var c="true"==b.params.hasNext;
a.lc.Kk="true"==b.params.hasPrevious;a.lc.hasNext=c;a.ea("previousNextChange")},jXa=function(a){g.hu(a.S);
a.S=g.Qt((0,g.C)(a.ls,a,1),864E5)},e9=function(a,b,c){c?$8("Sending: action="+b+", params="+g.zi(c)):$8("Sending: action="+b);
...
var d=this;this.u=a;this.J=b;this.Tb=c;this.events=new g.LC(this);this.Z=this.events.T(this.J,"onVolumeChange",function(e){BXa(d,e)});
this.D=!1;this.I=new g.uJ(64);this.i=new g.I(this.dO,500,this);this.B=new g.I(this.eO,1E3,this);this.S=new l7(this.ZX,0,this);this.C={};this.X=new g.I(this.MO,1E3,this);this.K=new m7(this.seekTo,1E3,this);this.oa=g.Ka;g.H(this,this.events);this.events.T(b,"onCaptionsTrackListChanged",this.RU);this.events.T(b,"captionschanged",this.hU);this.events.T(b,"captionssettingschanged",this.kO);this.events.T(b,"videoplayerreset",this.uA);this.events.T(b,"mdxautoplaycancel",function(){d.Tb.eK()});
a=this.Tb;a.isDisposed();a.subscribe("proxyStateChange",this.VM,this);a.subscribe("remotePlayerChange",this.Iw,this);a.subscribe("remoteQueueChange",this.uA,this);a.subscribe("previousNextChange",this.SM,this);a.subscribe("nowAutoplaying",this.LM,this);a.subscribe("autoplayDismissed",this.oM,this);g.H(this,this.i);g.H(this,this.B);g.H(this,this.S);g.H(this,this.X);g.H(this,this.K);this.kO();this.uA();this.Iw()},BXa=function(a,b){if(A9(a)){a.Tb.unsubscribe("remotePlayerChange",a.Iw,a);
var c=Math.round(b.volume);b=!!b.muted;var d=S8(a.Tb);if(c!==d.volume||b!==d.muted)a.Tb.setVolume(c,b),a.X.start();a.Tb.subscribe("remotePlayerChange",a.Iw,a)}},CXa=function(a){a.Xb(0);
a.i.stop();a.Ub(new g.uJ(64))},B9=function(a,b){if(A9(a)&&!a.D){var c=null;
b&&(c={style:a.J.getSubtitlesUserSettings()},g.Ze(c,b));a.Tb.uI(a.J.getVideoData(1).videoId,c);a.C=S8(a.Tb).trackData}},C9=function(a,b){var c=a.J.getPlaylist();
if(null===c||void 0===c?0:c.listId){var d=c.index;var e=c.listId.toString()}c=a.J.getVideoData(1);a.Tb.playVideo(c.videoId,b,d,e,c.playerParams,c.Za,$Ua(c));a.Ub(new g.uJ(1))},DXa=function(a,b){if(b){var c=a.J.getOption("captions","tracklist",{fL:1});
...
L:"ytp-remote",U:[{G:"div",L:"ytp-remote-display-status",U:[{G:"div",L:"ytp-remote-display-status-icon",U:[g.Bva()]},{G:"div",L:"ytp-remote-display-status-text",va:"{{statustext}}"}]}]});this.api=a;this.i=new g.$K(this,250);g.H(this,this.i);this.T(a,"presentingplayerstatechange",this.onStateChange);EXa(this,a.zb())},EXa=function(a,b){if(3===a.api.getPresentingPlayerType()){var c={RECEIVER_NAME:a.api.getOption("remote","currentReceiver").name};
b=g.T(b,128)?g.CH("Error on $RECEIVER_NAME",c):b.Ec()||g.T(b,4)?g.CH("Playing on $RECEIVER_NAME",c):g.CH("Connected to $RECEIVER_NAME",c);a.Pa("statustext",b);a.i.show()}else a.i.hide()},F9=function(a,b){g.xP.call(this,"Play on",0,a,b);
...
this.Rk={key:Z6(),name:"This computer"};this.ai=null;this.subscriptions=[];this.VF=this.Tb=null;this.Ho=[this.Rk];this.qn=this.Rk;this.Ad=new g.uJ(64);this.EL=0;this.wf=-1;this.Qw=!1;this.Ow=this.wt=null;if(!g.uE(this.player.V())&&!g.vE(this.player.V())){a=this.player;var b=g.jM(a);b&&(b=b.Kn())&&(b=new F9(a,b),g.H(this,b));b=new E9(a);g.H(this,b);g.tM(a,b.element,4);this.wt=new D9;g.H(this,this.wt);g.tM(a,this.wt.element,4);this.Qw=!!n9()}},H9=function(a){a.Ow&&(a.player.removeEventListener("presentingplayerstatechange",
a.Ow),a.Ow=null)},FXa=function(a,b,c){a.Ad=c;
a.player.ea("presentingplayerstatechange",new g.lH(c,b))},I9=function(a,b){if(b.key!==a.qn.key)if(b.key===a.Rk.key)t9();
else{var c;(c=!a.player.V().N("mdx_enable_privacy_disclosure_ui"))||(c=((c=g.N("PLAYER_CONFIG"))&&c.args&&void 0!==c.args.authuser?!0:!(!g.N("SESSION_INDEX")&&!g.N("LOGGED_IN")))||a.Qw||!a.wt);(c?0:g.LE(a.player.V())||g.OE(a.player.V()))&&GXa(a);a.qn=b;if(!a.player.V().N("disable_mdx_connection_in_mdx_module_for_music_web")||!g.vE(a.player.V())){var d=a.player.getPlaylistId();c=a.player.getVideoData(1);var e=c.videoId;if(!d&&!e||(2===a.player.getAppState()||1===a.player.getAppState())&&a.player.V().N("should_clear_video_data_on_player_cued_unstarted"))a=
...
j9()==b.key?T6("yt-remote-connection-change",!0):(t9(),m9(a||null),a=i9().Hh(),(b=a7(a,b.key))&&u9(b,1))}}},GXa=function(a){a.player.zb().Ec()?a.player.pauseVideo():(a.Ow=function(b){!a.Qw&&g.nH(b,8)&&(a.player.pauseVideo(),H9(a))},a.player.addEventListener("presentingplayerstatechange",a.Ow));
a.wt&&a.wt.zd();q9()||(y9=!0)},IVa={"\x00":"\\0",
"\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t","\x0B":"\\x0B",'"':'\\"',"\\":"\\\\","<":"\\u003C"},y7={"'":"\\'"},fVa={wZ:"atp",U$:"ska",F9:"que",v7:"mus",T$:"sus",x3:"dsp",b$:"seq",Y6:"mic",m2:"dpa",LZ:"cds",t7:"mlm",j2:"dsdtr"};U6.prototype.equals=function(a){return a?this.id==a.id:!1};
...
*/
g.Ua(l7,g.E);g.k=l7.prototype;g.k.EQ=function(a){this.C=arguments;this.i=!1;this.Mb?this.B=g.Ta()+this.Wf:this.Mb=g.Yh(this.D,this.Wf)};
...
g.k.FQ=function(){this.Mb&&(g.B.clearTimeout(this.Mb),this.Mb=null);this.B?(this.Mb=g.Yh(this.D,this.B-g.Ta()),this.B=null):this.u?this.i=!0:(this.i=!1,this.I.apply(null,this.C))};g.w(m7,g.E);g.k=m7.prototype;g.k.pI=function(a){this.B=arguments;this.Mb||this.u?this.i=!0:n7(this)};
...
o7.prototype.parse=function(a){return g.B.JSON.parse(a,void 0)};var q7=new g.rf;g.w(DVa,g.ue);g.k=s7.prototype;g.k.Zo=null;g.k.Km=!1;g.k.au=null;g.k.oH=null;g.k.Ct=null;g.k.Pt=null;g.k.cn=null;g.k.Ko=null;g.k.Aq=null;g.k.Lf=null;g.k.BB=0;g.k.Rj=null;g.k.zB=null;g.k.Tm=null;g.k.Hu=-1;g.k.SN=!0;g.k.vp=!1;g.k.nC=0;g.k.PA=null;var GVa={},v7={};g.k=s7.prototype;g.k.setTimeout=function(a){this.u=a};
g.k.GQ=function(a){a=a.target;var b=this.PA;b&&3==g.gj(a)?b.pI():this.WO(a)};
g.k.WO=function(a){try{if(a==this.Lf)a:{var b=g.gj(this.Lf),c=this.Lf.u,d=this.Lf.getStatus();if(g.Jc&&!g.Bc(10)||g.Xg&&!g.zc("420+")){if(4>b)break a}else if(3>b||3==b&&!g.lj(this.Lf))break a;this.vp||4!=b||7==c||(8==c||0>=d?this.i.Dj(3):this.i.Dj(2));z7(this);var e=this.Lf.getStatus();this.Hu=e;var f=g.lj(this.Lf);if(this.Km=200==e){4==b&&w7(this);if(this.D){for(a=!0;!this.vp&&this.BB<f.length;){var h=HVa(this,f);if(h==v7){4==b&&(this.Tm=4,r7(15),a=!1);break}else if(h==GVa){this.Tm=4;r7(16);a=!1;
break}else A7(this,h)}4==b&&0==f.length&&(this.Tm=1,r7(17),a=!1);this.Km=this.Km&&a;a||(w7(this),x7(this))}else A7(this,f);this.Km&&!this.vp&&(4==b?this.i.ey(this):(this.Km=!1,u7(this)))}else 400==e&&0<f.indexOf("Unknown SID")?(this.Tm=3,r7(13)):(this.Tm=0,r7(14)),w7(this),x7(this)}}catch(l){this.Lf&&g.lj(this.Lf)}finally{}};
g.k.yW=function(a){p7((0,g.C)(this.xW,this,a),0)};
g.k.xW=function(a){this.vp||(z7(this),A7(this,a),u7(this))};
g.k.dN=function(a){p7((0,g.C)(this.wW,this,a),0)};
g.k.wW=function(a){this.vp||(w7(this),this.Km=a,this.i.ey(this),this.i.Dj(4))};
g.k.cancel=function(){this.vp=!0;w7(this)};
g.k.HW=function(){this.au=null;var a=Date.now();0<=a-this.oH?(2!=this.Pt&&this.i.Dj(3),w7(this),this.Tm=2,r7(18),x7(this)):KVa(this,this.oH-a)};
g.k.getLastError=function(){return this.Tm};g.k=NVa.prototype;g.k.oC=null;g.k.uh=null;g.k.QA=!1;g.k.fO=null;g.k.Uy=null;g.k.RE=null;g.k.pC=null;g.k.Xh=null;g.k.vl=-1;g.k.Iu=null;g.k.Ru=null;g.k.connect=function(a){this.pC=a;a=C7(this.i,null,this.pC);r7(3);this.fO=Date.now();var b=this.i.S;null!=b?(this.Iu=b[0],(this.Ru=b[1])?(this.Xh=1,OVa(this)):(this.Xh=2,E7(this))):(Q6(a,"MODE","init"),this.uh=new s7(this,void 0,void 0,void 0),this.uh.Zo=this.oC,t7(this.uh,a,!1,null,!0),this.Xh=0)};
g.k.uR=function(a){if(a)this.Xh=2,E7(this);else{r7(4);var b=this.i;b.ek=b.jn.vl;L7(b,9)}a&&this.Dj(2)};
g.k.xD=function(a){return this.i.xD(a)};
g.k.abort=function(){this.uh&&(this.uh.cancel(),this.uh=null);this.vl=-1};
g.k.sf=function(){return!1};
g.k.WM=function(a,b){this.vl=a.Hu;if(0==this.Xh)if(b){try{var c=this.u.parse(b)}catch(d){a=this.i;a.ek=this.vl;L7(a,2);return}this.Iu=c[0];this.Ru=c[1]}else a=this.i,a.ek=this.vl,L7(a,2);else if(2==this.Xh)if(this.QA)r7(7),this.RE=Date.now();else if("11111"==b){if(r7(6),this.QA=!0,this.Uy=Date.now(),a=this.Uy-this.fO,!g.Jc||g.Bc(10)||500>a)this.vl=200,this.uh.cancel(),r7(12),D7(this.i,this,!0)}else r7(8),this.Uy=this.RE=Date.now(),this.QA=!1};
g.k.ey=function(){this.vl=this.uh.Hu;if(this.uh.Km)0==this.Xh?this.Ru?(this.Xh=1,OVa(this)):(this.Xh=2,E7(this)):2==this.Xh&&((!g.Jc||g.Bc(10)?!this.QA:200>this.RE-this.Uy)?(r7(11),D7(this.i,this,!1)):(r7(12),D7(this.i,this,!0)));else{0==this.Xh?r7(9):2==this.Xh&&r7(10);var a=this.i;this.uh.getLastError();a.ek=this.vl;L7(a,2)}};
g.k.qx=function(){return this.i.qx()};
g.k.isActive=function(){return this.i.isActive()};
g.k.Dj=function(a){this.i.Dj(a)};g.k=F7.prototype;g.k.dk=null;g.k.xv=null;g.k.Ug=null;g.k.Je=null;g.k.qC=null;g.k.Vy=null;g.k.sJ=null;g.k.gy=null;g.k.qw=0;g.k.xT=0;g.k.Mf=null;g.k.Cn=null;g.k.Il=null;g.k.Ep=null;g.k.jn=null;g.k.xB=null;g.k.Ss=-1;g.k.DL=-1;g.k.ek=-1;g.k.ws=0;g.k.Rr=0;g.k.wp=8;g.Ua(QVa,g.ue);g.Ua(RVa,g.ue);g.k=F7.prototype;g.k.connect=function(a,b,c,d,e){r7(0);this.qC=b;this.xv=c||{};d&&void 0!==e&&(this.xv.OSID=d,this.xv.OAID=e);this.I?(p7((0,g.C)(this.OJ,this,a),100),VVa(this)):this.OJ(a)};
g.k.OJ=function(a){this.jn=new NVa(this);this.jn.oC=this.dk;this.jn.u=this.D;this.jn.connect(a)};
g.k.sf=function(){return 0==this.i};
g.k.getState=function(){return this.i};
g.k.bN=function(a){this.Cn=null;ZVa(this,a)};
g.k.aN=function(){this.Il=null;this.Je=new s7(this,this.B,"rpc",this.K);this.Je.Zo=this.dk;this.Je.nC=0;var a=this.sJ.clone();g.il(a,"RID","rpc");g.il(a,"SID",this.B);g.il(a,"CI",this.xB?"0":"1");g.il(a,"AID",this.Ss);G7(this,a);if(!g.Jc||g.Bc(10))g.il(a,"TYPE","xmlhttp"),t7(this.Je,a,!0,this.gy,!1);else{g.il(a,"TYPE","html");var b=this.Je,c=!!this.gy;b.Pt=3;b.cn=P6(a.clone());JVa(b,c)}};
g.k.WM=function(a,b){if(0!=this.i&&(this.Je==a||this.Ug==a))if(this.ek=a.Hu,this.Ug==a&&3==this.i)if(7<this.wp){try{var c=this.D.parse(b)}catch(d){c=null}if(Array.isArray(c)&&3==c.length)if(a=c,0==a[0])a:{if(!this.Il){if(this.Je)if(this.Je.Ct+3E3<this.Ug.Ct)I7(this),this.Je.cancel(),this.Je=null;else break a;K7(this);r7(19)}}else this.DL=a[1],0<this.DL-this.Ss&&37500>a[2]&&this.xB&&0==this.Rr&&!this.Ep&&(this.Ep=p7((0,g.C)(this.eU,this),6E3));else L7(this,11)}else null!=b&&L7(this,11);else if(this.Je==
a&&I7(this),!g.kb(b))for(a=this.D.parse(b),b=0;b<a.length;b++)c=a[b],this.Ss=c[0],c=c[1],2==this.i?"c"==c[0]?(this.B=c[1],this.gy=c[2],c=c[3],null!=c?this.wp=c:this.wp=6,this.i=3,this.Mf&&this.Mf.KJ(),this.sJ=C7(this,this.qx()?this.gy:null,this.qC),$Va(this)):"stop"==c[0]&&L7(this,7):3==this.i&&("stop"==c[0]?L7(this,7):"noop"!=c[0]&&this.Mf&&this.Mf.JJ(c),this.Rr=0)};
g.k.eU=function(){null!=this.Ep&&(this.Ep=null,this.Je.cancel(),this.Je=null,K7(this),r7(20))};
g.k.ey=function(a){if(this.Je==a){I7(this);this.Je=null;var b=2}else if(this.Ug==a)this.Ug=null,b=1;else return;this.ek=a.Hu;if(0!=this.i)if(a.Km)if(1==b){b=Date.now()-a.Ct;var c=q7;c.dispatchEvent(new QVa(c,a.Aq?a.Aq.length:0,b,this.ws));H7(this);this.C.length=0}else $Va(this);else{c=a.getLastError();var d;if(!(d=3==c||7==c||0==c&&0<this.ek)){if(d=1==b)this.Ug||this.Cn||1==this.i||2<=this.ws?d=!1:(this.Cn=p7((0,g.C)(this.bN,this,a),aWa(this,this.ws)),this.ws++,d=!0);d=!(d||2==b&&K7(this))}if(d)switch(c){case 1:L7(this,
...
g.k.IX=function(a){a?r7(2):(r7(1),bWa(this,8))};
...
g.k.Dj=function(a){var b=q7;b.dispatchEvent(new RVa(b,a))};
...
g.k.xi=function(){for(var a=[],b=this.i.length-1;0<=b;--b)a.push(this.i[b]);var c=this.u.length;for(b=0;b<c;++b)a.push(this.u[b]);return a};g.Ua(M7,g.E);g.k=M7.prototype;g.k.pW=function(){this.Wf=Math.min(3E5,2*this.Wf);this.B();this.u&&this.start()};
...
g.k.connect=function(a,b,c){if(!this.i||2!=this.i.getState()){this.X="";this.u.stop();this.D=a||null;this.C=b||0;a=this.xa+"/test";b=this.xa+"/bind";var d=new F7(c?c.firstTestResults:null,c?c.secondTestResults:null,this.Aa),e=this.i;e&&(e.Mf=null);d.Mf=this;this.i=d;O7(this);if(this.i){d=g.N("ID_TOKEN");var f=this.i.dk||{};d?f["x-youtube-identity-token"]=d:delete f["x-youtube-identity-token"];this.i.dk=f}e?(3!=e.getState()&&0==XVa(e)||e.getState(),this.i.connect(a,b,this.I,e.B,e.Ss)):c?this.i.connect(a,
...
g.k.IJ=function(a){var b=2==a&&401==this.i.ek;4==a||b||this.u.start();this.ea("handlerError",a,b)};
...
g.k.bB=function(a){(this.I.loungeIdToken=a)||this.u.stop();if(this.Ba&&this.i){var b=this.i.dk||{};a?b["X-YouTube-LoungeId-Token"]=a:delete b["X-YouTube-LoungeId-Token"];this.i.dk=b}};
g.k.mX=function(){this.u.isActive();0==XVa(this.i)&&this.connect(this.D,this.C)};Q7.prototype.C=function(a,b,c,d){b?a(d):a({text:c.responseText})};
...
Y7.prototype.info=function(a){U7(this.I,a)};g.w(Z7,g.Q);g.k=Z7.prototype;g.k.start=function(){!this.i&&isNaN(this.Mb)&&this.nN()};
g.k.stop=function(){this.i&&(this.i.abort(),this.i=null);isNaN(this.Mb)||(g.hu(this.Mb),this.Mb=NaN)};
g.k.ya=function(){this.stop();g.Q.prototype.ya.call(this)};
g.k.nN=function(){this.Mb=NaN;this.i=g.lu(R7(this.B,"/pairing/get_screen"),{method:"POST",postParams:{pairing_code:this.K},timeout:5E3,onSuccess:(0,g.C)(this.IQ,this),onError:(0,g.C)(this.HQ,this),onTimeout:(0,g.C)(this.JQ,this)})};
...
g.k.HQ=function(a){this.i=null;a.status&&404==a.status?this.u>=HXa.length?this.ea("pairingFailed",Error("DIAL polling timed out")):(a=HXa[this.u],this.Mb=g.Qt((0,g.C)(this.nN,this),a),this.u++):this.ea("pairingFailed",Error("Server error "+a.status))};
...
g.k.hG=function(){g.hu(this.B);this.B=NaN;this.u&&this.u.abort();var a=tWa(this);if(R6(a)){var b=R7(this.D,"/pairing/get_screen_availability");this.u=S7(this.D,b,{lounge_token:g.Ne(a).join(",")},(0,g.C)(this.VV,this,a),(0,g.C)(this.UV,this))}else f8(this,{}),g8(this)};
g.k.VV=function(a,b){this.u=null;var c=g.Ne(tWa(this));if(g.qc(c,g.Ne(a))){b=b.screens||[];c={};for(var d=0,e=b.length;d<e;++d)c[a[b[d].loungeToken]]="online"==b[d].status;f8(this,c);g8(this)}else this.ke("Changing Screen set during request."),this.hG()};
...
g.k.LW=function(a,b){if(!this.isDisposed())if(b)if(b=S6(b),g.Oa(b))switch(a=""+b.type,b=b.data||{},this.info("onYoutubeMessage_: "+a+" "+g.zi(b)),a){case "mdxSessionStatus":CWa(this,b);break;case "loungeToken":FWa(this,b);break;default:m8(this,"Unknown youtube message: "+a)}else m8(this,"Unable to parse message.");else m8(this,"No data in message.")};
...
u8.prototype.Ts=function(){g.hu(this.u);this.u=NaN;var a=a7(this.B.Hh(),this.i.label);a?l8(this,a):this.zg(Error("No such screen"))};
...
g.k.sX=function(a){this.isDisposed()?this.ke("Setting connection data on disposed cast v2"):this.i?this.i.Ts(a):this.ke("Setting connection data without a session")};
...
g.k.requestSession=function(){chrome.cast.requestSession((0,g.C)(this.XM,this),(0,g.C)(this.YV,this))};
...
v8.prototype.setLaunchParams=v8.prototype.sX;v8.prototype.setConnectedScreenStatus=v8.prototype.rX;v8.prototype.stopSession=v8.prototype.OQ;v8.prototype.getCastSession=v8.prototype.NQ;v8.prototype.requestSession=v8.prototype.requestSession;v8.prototype.init=v8.prototype.init;v8.prototype.dispose=v8.prototype.dispose;var E8=[];g.k=J8.prototype;
g.k.reset=function(a){this.listId="";this.index=-1;this.videoId="";K8(this);this.volume=-1;this.muted=!1;a&&(this.index=a.index,this.listId=a.listId,this.videoId=a.videoId,this.playerState=a.playerState,this.volume=a.volume,this.muted=a.muted,this.audioTrackId=a.audioTrackId,this.trackData=a.trackData,this.Kk=a.hasPrevious,this.hasNext=a.hasNext,this.K=a.playerTime,this.I=a.playerTimeAt,this.C=a.seekableStart,this.i=a.seekableEnd,this.D=a.duration,this.S=a.loadedTime,this.B=a.liveIngestionTime,this.u=
!isNaN(this.B))};
...
g.k.Ur=function(){if(T8(this)){X8(this,"clearPlaylist");var a=S8(this);a.reset();V8(this,a);this.ea("remotePlayerChange")}else U8(this,this.Ur)};
...
g.k.ya=function(){b9(this);d9(this);c9(this);g.hu(this.K);this.K=NaN;g.hu(this.S);this.S=NaN;this.B=null;g.$u(this.X);this.X.length=0;this.i.dispose();g.Q.prototype.ya.call(this);this.C=this.I=this.u=this.lc=this.i=null};
g.k.nS=function(){this.ls(2)};
g.k.oU=function(){$8("Channel opened");this.xa&&(this.xa=!1,c9(this),this.oa=g.Qt((0,g.C)(function(){$8("Timing out waiting for a screen.");this.ls(1)},this),15E3));
...
g.k.fX=function(){if(this.B){var a=this.B;this.B=null;this.lc.videoId!=a&&e9(this,"getNowPlaying")}};
g.k.kS=function(){var a=3;this.isDisposed()||(a=0,isNaN(this.Nv())?P7(this.i)&&isNaN(this.D)&&(a=1):a=2);return a};
g.k.ls=function(a){$8("Disconnecting with "+a);g.Ia("yt.mdx.remote.remoteClient_",null,void 0);b9(this);this.ea("beforeDisconnect",a);1==a&&f7();gWa(this.i,a);this.dispose()};
g.k.iS=function(){var a=this.lc;this.B&&(a=this.lc.clone(),O8(a,this.B,a.index));return P8(a)};
g.k.tX=function(a){var b=new J8(a);b.videoId&&b.videoId!=this.lc.videoId&&(this.B=b.videoId,g.hu(this.K),this.K=g.Qt((0,g.C)(this.fX,this),5E3));var c=[];this.lc.listId==b.listId&&this.lc.videoId==b.videoId&&this.lc.index==b.index||c.push("remoteQueueChange");this.lc.playerState==b.playerState&&this.lc.volume==b.volume&&this.lc.muted==b.muted&&N8(this.lc)==N8(b)&&g.zi(this.lc.trackData)==g.zi(b.trackData)||c.push("remotePlayerChange");this.lc.reset(a);g.sc(c,function(d){this.ea(d)},this)};
...
g.k.qX=function(a,b){e9(this,a,b);jXa(this)};
...
Z8.prototype.subscribe=Z8.prototype.subscribe;Z8.prototype.unsubscribeByKey=Z8.prototype.eg;Z8.prototype.getProxyState=Z8.prototype.kS;Z8.prototype.disconnect=Z8.prototype.ls;Z8.prototype.getPlayerContextData=Z8.prototype.iS;Z8.prototype.setPlayerContextData=Z8.prototype.tX;Z8.prototype.getOtherConnectedRemoteId=Z8.prototype.HK;Z8.prototype.getReconnectTimeout=Z8.prototype.Nv;Z8.prototype.getAutoplayMode=Z8.prototype.fS;Z8.prototype.getAutoplayVideoId=Z8.prototype.gS;Z8.prototype.reconnect=Z8.prototype.PQ;
Z8.prototype.sendMessage=Z8.prototype.qX;Z8.prototype.getXsrfToken=Z8.prototype.vI;Z8.prototype.isCapabilitySupportedOnConnectedDevices=Z8.prototype.oL;g.w(f9,Y7);g.k=f9.prototype;g.k.Hh=function(a){return this.Se.$_gs(a)};
...
h8.prototype.$_st=h8.prototype.start;h8.prototype.$_gspc=h8.prototype.KQ;h8.prototype.$_gsppc=h8.prototype.rI;h8.prototype.$_c=h8.prototype.contains;h8.prototype.$_g=h8.prototype.get;h8.prototype.$_a=h8.prototype.add;h8.prototype.$_un=h8.prototype.vB;h8.prototype.$_r=h8.prototype.remove;h8.prototype.$_gs=h8.prototype.Hh;h8.prototype.$_gos=h8.prototype.qI;h8.prototype.$_s=h8.prototype.subscribe;h8.prototype.$_ubk=h8.prototype.eg;var s9=null,y9=!1,g9=null,h9=null,x9=null,l9=[];g.w(z9,g.E);g.k=z9.prototype;g.k.ya=function(){g.E.prototype.ya.call(this);this.i.stop();this.B.stop();this.S.stop();this.oa();var a=this.Tb;a.unsubscribe("proxyStateChange",this.VM,this);a.unsubscribe("remotePlayerChange",this.Iw,this);a.unsubscribe("remoteQueueChange",this.uA,this);a.unsubscribe("previousNextChange",this.SM,this);a.unsubscribe("nowAutoplaying",this.LM,this);a.unsubscribe("autoplayDismissed",this.oM,this);this.Tb=this.u=null};
g.k.uj=function(a){var b=g.Ba.apply(1,arguments);if(2!=this.Tb.B)if(A9(this)){var c=a;if(!S8(this.Tb).isAdPlaying()||"control_seek"!==c)switch(c){case "control_toggle_play_pause":S8(this.Tb).Ec()?this.Tb.pause():this.Tb.play();break;case "control_play":this.Tb.play();break;case "control_pause":this.Tb.pause();break;case "control_seek":this.K.pI(b[0],b[1]);break;case "control_subtitles_set_track":B9(this,b[0]);break;case "control_set_audio_track":this.setAudioTrack(b[0])}}else switch(a){case "control_toggle_play_pause":case "control_play":case "control_pause":b=
...
g.k.ZX=function(a){this.uj("control_subtitles_set_track",g.Se(a)?null:a)};
...
g.k.Iw=function(){if(A9(this)){this.i.stop();var a=S8(this.Tb);switch(a.playerState){case 1080:case 1081:case 1084:case 1085:this.u.wf=1;break;case 1082:case 1083:this.u.wf=0;break;default:this.u.wf=-1}switch(a.playerState){case 1081:case 1:this.Ub(new g.uJ(8));this.dO();break;case 1085:case 3:this.Ub(new g.uJ(9));break;case 1083:case 0:this.Ub(new g.uJ(2));this.K.stop();this.Xb(this.J.getVideoData().lengthSeconds);break;case 1084:this.Ub(new g.uJ(4));break;case 2:this.Ub(new g.uJ(4));this.Xb(N8(a));
break;case -1:this.Ub(new g.uJ(64));break;case -1E3:this.Ub(new g.uJ(128,{errorCode:"mdx.remoteerror",errorMessage:"This video is not available for remote playback."}))}a=S8(this.Tb).trackData;var b=this.C;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==b.languageName&&a.kind==b.kind:1)||(this.C=a,DXa(this,a));a=S8(this.Tb);-1===a.volume||Math.round(this.J.getVolume())===a.volume&&this.J.isMuted()===a.muted||this.X.isActive()||this.MO()}else CXa(this)};
...
g.k.MO=function(){var a=this;if(A9(this)){var b=S8(this.Tb);this.events.qc(this.Z);b.muted?this.J.mute():this.J.unMute();this.J.setVolume(b.volume);this.Z=this.events.T(this.J,"onVolumeChange",function(c){BXa(a,c)})}};
g.k.dO=function(){this.i.stop();if(!this.Tb.isDisposed()){var a=S8(this.Tb);a.Ec()&&this.Ub(new g.uJ(8));this.Xb(N8(a));this.i.start()}};
g.k.eO=function(){this.B.stop();this.i.stop();var a=this.Tb.C.getReconnectTimeout();2==this.Tb.B&&!isNaN(a)&&this.B.start()};
g.k.Ub=function(a){this.B.stop();var b=this.I;if(!g.zJ(b,a)){var c=g.T(a,2);c!==g.T(this.I,2)&&this.J.Ht(c);this.I=a;FXa(this.u,b,a)}};g.w(D9,g.W);D9.prototype.zd=function(){this.i.show()};
D9.prototype.Eb=function(){this.i.hide()};
D9.prototype.u=function(){T6("mdx-privacy-popup-cancel");this.Eb()};
D9.prototype.B=function(){T6("mdx-privacy-popup-confirm");this.Eb()};g.w(E9,g.W);E9.prototype.onStateChange=function(a){EXa(this,a.state)};g.w(F9,g.xP);F9.prototype.D=function(){var a=this.J.getOption("remote","receivers");a&&1<a.length&&!this.J.getOption("remote","quickCast")?(this.Ho=g.tc(a,this.i,this),g.yP(this,g.nn(a,this.i)),a=this.J.getOption("remote","currentReceiver"),a=this.i(a),this.options[a]&&this.Wh(a),this.enable(!0)):this.enable(!1)};
F9.prototype.i=function(a){return a.key};
F9.prototype.nj=function(a){return"cast-selector-receiver"===a?"Cast...":this.Ho[a].name};
F9.prototype.Af=function(a){g.xP.prototype.Af.call(this,a);this.J.setOption("remote","currentReceiver",this.Ho[a]);this.Ab.Eb()};g.w(G9,g.GM);g.k=G9.prototype;
...
this));this.subscriptions.push(g.wv("yt-remote-auto-connect",this.EV,this));this.subscriptions.push(g.wv("yt-remote-receiver-resumed",this.CV,this));this.subscriptions.push(g.wv("mdx-privacy-popup-confirm",this.UW,this));this.subscriptions.push(g.wv("mdx-privacy-popup-cancel",this.TW,this));this.UM()};
g.k.load=function(){this.player.cancelPlayback();g.GM.prototype.load.call(this);this.ai=new z9(this,this.player,this.Tb);var a=(a=AXa())?a.currentTime:0;var b=w9()?new R8(q9(),void 0):null;0==a&&b&&(a=N8(S8(b)));0!==a&&this.Xb(a);FXa(this,this.Ad,this.Ad);this.player.Zk(6)};
g.k.unload=function(){this.player.ea("mdxautoplaycanceled");this.qn=this.Rk;(0,g.se)(this.ai,this.Tb);this.Tb=this.ai=null;g.GM.prototype.unload.call(this);this.player.Zk(5);H9(this)};
g.k.ya=function(){g.xv(this.subscriptions);g.GM.prototype.ya.call(this)};
g.k.Sk=function(a){var b=g.Ba.apply(1,arguments);this.loaded&&this.ai.uj.apply(this.ai,[a].concat(g.ma(b)))};
g.k.getAdState=function(){return this.wf};
g.k.Kk=function(){return this.Tb?S8(this.Tb).Kk:!1};
g.k.hasNext=function(){return this.Tb?S8(this.Tb).hasNext:!1};
g.k.Xb=function(a,b){this.EL=a||0;this.player.ea("progresssync",a,b);this.player.Oa("onVideoProgress",a||0)};
...
g.k.gU=function(a){1===a&&(this.VF=this.Tb?S8(this.Tb):null)};
g.k.GV=function(){var a=w9()?new R8(q9(),void 0):null;if(a){var b=this.qn;this.loaded&&this.unload();this.Tb=a;this.VF=null;b.key!==this.Rk.key&&(this.qn=b,this.load())}else(0,g.re)(this.Tb),this.Tb=null,this.loaded&&(this.unload(),(a=this.VF)&&a.videoId===this.player.getVideoData().videoId&&this.player.cueVideoById(a.videoId,N8(a)));this.player.ea("videodatachange","newdata",this.player.getVideoData(),3)};
g.k.UM=function(){var a=[this.Rk],b=a.concat,c=xXa();F8()&&g.vy("yt-remote-cast-available")&&c.push({key:"cast-selector-receiver",name:"Cast..."});this.Ho=b.call(a,c);a=r9()||this.Rk;I9(this,a);this.player.Oa("onMdxReceiversChange")};
g.k.EV=function(){var a=r9();I9(this,a)};
g.k.CV=function(){this.qn=r9()};
g.k.UW=function(){this.Qw=!0;H9(this);y9=!1;s9&&u9(s9,1);s9=null};
g.k.TW=function(){this.Qw=!1;H9(this);I9(this,this.Rk);this.qn=this.Rk;y9=!1;s9=null;this.player.playVideo()};
g.k.kf=function(a,b){switch(a){case "casting":return this.loaded;case "receivers":return this.Ho;case "currentReceiver":return b&&("cast-selector-receiver"===b.key?H8():I9(this,b)),this.loaded?this.qn:this.Rk;case "quickCast":return 2===this.Ho.length&&"cast-selector-receiver"===this.Ho[1].key?(b&&H8(),!0):!1}};
g.k.SG=function(){this.Tb.SG()};
